     ...
     <div class="container-fluid">
       <div class="card">
        ...
        <form action="" enctype="multipart/form-data" method="post">
          ...
          <br>
          <button type="submit" class="btn btn-info btn-block" name="restore" onclick="return confirm('Perhatian !!!! proses restore akan merubah total seluruh data yang ada berdasarkan file yang dipilih sebelum restore harap disarankan untuk melakukan backup terlebih dahulu, Apakah anda sudah yakin akan melanjutkan proses ini?')"><i class="fas fa-cog"></i> Mulai Restore</button>
        </form>
        <?php
